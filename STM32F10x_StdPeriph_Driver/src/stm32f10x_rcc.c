...
void RCC_HSEConfig(uint32_t RCC_HSE)
{
  ...
  switch(RCC_HSE)
  {
    ...
    case RCC_HSE_Bypass:
      /* SetValue HSEBYP and HSEON bits */
...
void RCC_AdjustHSICalibrationValue(uint8_t HSICalibrationValue)
{
  ...
  /* SetValue the HSITRIM[4:0] bits according to HSICalibrationValue value */
...
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLMul)
{
  ...
  /* SetValue the PLL configuration bits */
...
void RCC_PREDIV1Config(uint32_t RCC_PREDIV1_Source, uint32_t RCC_PREDIV1_Div)
{
  ...
  /* SetValue the PREDIV1 clock source and division factor */
...
void RCC_PREDIV2Config(uint32_t RCC_PREDIV2_Div)
{
  ...
  /* SetValue the PREDIV2 division factor */
...
void RCC_PLL2Config(uint32_t RCC_PLL2Mul)
{
  ...
  /* SetValue the PLL2 configuration bits */
  tmpreg |= RCC_PLL2Mul;
  /* Store the new value */
  RCC->CFGR2 = tmpreg;
}
...
void RCC_PLL3Config(uint32_t RCC_PLL3Mul)
{
  ...
  /* SetValue the PLL3 configuration bits */
  tmpreg |= RCC_PLL3Mul;
  /* Store the new value */
  RCC->CFGR2 = tmpreg;
}
...
void RCC_SYSCLKConfig(uint32_t RCC_SYSCLKSource)
{
  ...
  /* Clear SW[1:0] bits */
  tmpreg &= CFGR_SW_Mask;
  /* SetValue SW[1:0] bits according to RCC_SYSCLKSource value */
...
void RCC_HCLKConfig(uint32_t RCC_SYSCLK)
{
  ...
  /* SetValue HPRE[3:0] bits according to RCC_SYSCLK value */
  tmpreg |= RCC_SYSCLK;
  /* Store the new value */
  RCC->CFGR = tmpreg;
}
...
void RCC_PCLK1Config(uint32_t RCC_HCLK)
{
  ...
  /* SetValue PPRE1[2:0] bits according to RCC_HCLK value */
  tmpreg |= RCC_HCLK;
  /* Store the new value */
  RCC->CFGR = tmpreg;
}
...
void RCC_PCLK2Config(uint32_t RCC_HCLK)
{
  ...
  /* SetValue PPRE2[2:0] bits according to RCC_HCLK value */
  tmpreg |= RCC_HCLK << 3;
  /* Store the new value */
  RCC->CFGR = tmpreg;
}
...
void RCC_ADCCLKConfig(uint32_t RCC_PCLK2)
{
  ...
  /* SetValue ADCPRE[1:0] bits according to RCC_PCLK2 value */
  tmpreg |= RCC_PCLK2;
  /* Store the new value */
  RCC->CFGR = tmpreg;
}
...
void RCC_LSEConfig(uint8_t RCC_LSE)
{
  ...
  *(__IO uint8_t *) BDCR_ADDRESS = RCC_LSE_OFF;
  ...
  switch(RCC_LSE)
  {
    ...
    case RCC_LSE_Bypass:
      /* SetValue LSEBYP and LSEON bits */
...
{
  /* SetValue RMVF bit to clear the reset flags */
