...
uint8_t CAN_Init(CAN_TypeDef* CANx, CAN_InitTypeDef* CAN_InitStruct)
{
  ...
  {
    /* SetValue the time triggered communication mode */
    ...
    /* SetValue the automatic bus-off management */
    ...
    /* SetValue the automatic wake-up mode */
    ...
    /* SetValue the no automatic retransmission */
    ...
    /* SetValue the receive FIFO locked mode */
    ...
    /* SetValue the transmit FIFO priority */
    ...
    /* SetValue the bit timing register */
...
/**
  ...
  *                        - CAN_ERRORCODE_SoftwareSetErr   Software SetValue Error
  */
